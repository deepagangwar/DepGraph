...
![DepGraph — dependency graph explorer](public/assets/screenshot-1.png)
*Exploring a package's transitive dependencies in the graph view.*

![DepGraph — maintainer bus-factor risk](public/assets/screenshot-2.png)
*Bus-factor risk dashboard: packages with a single maintainer and their downstream reach.*

![DepGraph — vulnerability blast radius](public/assets/screenshot-3.png)
*Tracing an inherited vulnerability upstream through the dependency chain.*

![DepGraph — shortest path finder](public/assets/screenshot-4.png)
*Finding the shortest dependency path between two packages.*

![DepGraph — package detail view](public/assets/screenshot-5.png)
*Package detail view showing maintainers, dependencies, and known vulnerabilities.*
...
public/
  ...
  assets/                Screenshots and static images used in this README
```
